<%@ Page Title="" Language="C#" MasterPageFile="~/ProDevs.Master" AutoEventWireup="true" CodeBehind="ProductEdit.aspx.cs" Inherits="Pro_Devs.ProductEdit" %>
        ...
        <asp:Panel ID="pnlEditProduct" runat="server" CssClass="card p-4">
            <div class="card-body">
                ...
                <form >
                    ...
                    <div class="form-group">
                        <asp:Button ID="btnSaveChanges" runat="server" CssClass="btn btn-success" Text="Save Changes" OnClick="btnSaveChanges_Click" />
                    </div>
                </form>
            </div>
        </asp:Panel>
